...
@Configuration
@ComponentScan({ "com.ailin.practice" })
    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.ailin.practice");
                servletContext.setInitParameter("tapestry.development-modules", "com.ailin.practice.services.DevelopmentModule");
